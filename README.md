...
- **Balanced fundamentals:** the game must not collapse into astronomy, physics or equations. History, civilization, life, evolution, the living world, mind, language, symbols and general knowledge are first-class foundations; cosmic and mathematical questions earn their place by revealing something fundamental. The model chooses freely without a visible rotation or quota.
- **Numerical intelligence:** quantitative questions appear when they reveal structure—not as a compulsory identity. Short deductions have an intelligence-test snap but do not claim to measure IQ. Prefer meaningful scale, ratios, powers, probability, constants, timelines, geometry and compact derivations over arithmetic grind; provide needed premises, units and rounding. The prompt mix is not structurally guaranteed.
