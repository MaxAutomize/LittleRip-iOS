...
Local validation checks only the JSON shape, four short choices, one index, explanation and display label. It does not store questions, remember concepts or build a finite bank. Generation quality still depends on the model.
